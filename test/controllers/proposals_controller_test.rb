...
class ProposalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create proposal" do
    assert_difference('Proposal.count') do
      post proposals_url, params: { proposal: { item_id: @proposal.item_id, poll_id: @proposal.poll_id } }
    end
  ...
  test "should update proposal" do
    patch proposal_url(@proposal), params: { proposal: { item_id: @proposal.item_id, poll_id: @proposal.poll_id } }
